...
class WP_Twitter_Cards {
	...
	public static function admin_enqueue_scripts( $hook ) {
		if ( in_array( $hook, array('post-new.php', 'post.php') ) ) {
			$directory_uri = apply_filters( 'twitter_card_install_directory', plugins_url( '', dirname( __FILE__ ) ), __FILE__ );
			wp_enqueue_script( 'twitter-card-metabox', sprintf( '%s/%s', untrailingslashit( $directory_uri ), 'metabox.js' ), array( 'jquery' ) );
